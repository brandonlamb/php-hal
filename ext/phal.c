...
static PHP_MINIT_FUNCTION(phal)
{
#if PHP_VERSION_ID < 50500
...
#ifndef ZEPHIR_RELEASE
static PHP_MSHUTDOWN_FUNCTION(phal)
{
 ...
 */
static void php_zephir_init_globals(zend_phal_globals *zephir_globals TSRMLS_DC)
{
...
static PHP_RINIT_FUNCTION(phal)
{

	zend_phal_globals *zephir_globals_ptr = ZEPHIR_VGLOBAL;
...
static PHP_RSHUTDOWN_FUNCTION(phal)
{
...
static PHP_MINFO_FUNCTION(phal)
{
	php_info_print_box_start(0);
	php_printf("%s", PHP_PHAL_DESCRIPTION);
	php_info_print_box_end();

	php_info_print_table_start();
	php_info_print_table_header(2, PHP_PHAL_NAME, "enabled");
	php_info_print_table_row(2, "Author", PHP_PHAL_AUTHOR);
	php_info_print_table_row(2, "Version", PHP_PHAL_VERSION);
	php_info_print_table_row(2, "Powered by Zephir", "Version " PHP_PHAL_ZEPVERSION);
	php_info_print_table_end();


}

static PHP_GINIT_FUNCTION(phal)
{
	php_zephir_init_globals(phal_globals TSRMLS_CC);
}

static PHP_GSHUTDOWN_FUNCTION(phal)
{

}

zend_module_entry phal_module_entry = {
...
#ifdef COMPILE_DL_PHAL
ZEND_GET_MODULE(phal)
#endif
