...
ZEPHIR_INIT_CLASS(Phal_Format_Reader_AbstractJsonReader) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Phal\\Format\\Reader, AbstractJsonReader, phal, format_reader_abstractjsonreader, phal_format_abstractreader_ce, phal_format_reader_abstractjsonreader_method_entry, ZEND_ACC_EXPLICIT_ABSTRACT_CLASS);

	zend_class_implements(phal_format_reader_abstractjsonreader_ce TSRMLS_CC, 1, phal_format_readerinterface_ce);
	return SUCCESS;
